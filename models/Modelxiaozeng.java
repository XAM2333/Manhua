...
public static class Modelxiaozeng extends EntityModel<Entity> {
	...
	public Modelxiaozeng() {
		...
		head.setTextureOffset(0, 12).addBox(-8.5F, -5.4935F, -0.5399F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		head.setTextureOffset(0, 0).addBox(-8.5F, -5.4935F, -2.2399F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		head.setTextureOffset(10, 13).addBox(-8.5F, -5.4935F, 1.1601F, 1.0F, 3.0F, 1.0F, 0.0F, false);

		cube_r1 = new ModelRenderer(this);
		cube_r1.setRotationPoint(-8.0F, -4.4935F, 1.3709F);
		head.addChild(cube_r1);
		setRotationAngle(cube_r1, -0.1309F, 0.0F, 0.0F);
		cube_r1.setTextureOffset(15, 0).addBox(-0.5F, -1.8F, -0.3608F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		...
		cube_r4.setTextureOffset(4, 12).addBox(-1.0F, -1.7F, 0.25F, 1.0F, 3.0F, 1.0F, 0.0F, false);

		cube_r5 = new ModelRenderer(this);
		cube_r5.setRotationPoint(-7.5F, -3.9935F, -0.4899F);
		head.addChild(cube_r5);
		setRotationAngle(cube_r5, -0.1309F, 0.0F, 0.0F);
		cube_r5.setTextureOffset(12, 3).addBox(-1.0F, -2.3F, -0.375F, 1.0F, 3.0F, 1.0F, 0.0F, false);

		cube_r6 = new ModelRenderer(this);
		cube_r6.setRotationPoint(-8.0F, -4.8935F, 1.8861F);
		head.addChild(cube_r6);
		setRotationAngle(cube_r6, 0.1309F, 0.0F, 0.0F);
		cube_r6.setTextureOffset(14, 13).addBox(-0.5F, -1.4F, -0.501F, 1.0F, 3.0F, 1.0F, 0.0F, false);
