...
public static class Modelxiaopeng extends EntityModel<Entity> {
	...
	public Modelxiaopeng() {
		...
		cube_r1.setRotationPoint(-7.5F, 25.5065F, 5.5101F);
		head.addChild(cube_r1);
		setRotationAngle(cube_r1, 0.0873F, 0.0F, 0.0F);
		cube_r1.setTextureOffset(3, 3).addBox(-1.0F, -31.5F, -1.0F, 1.0F, 3.0F, 1.0F, 0.0F, false);

		cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(-7.5F, 25.5065F, 5.5101F);
		head.addChild(cube_r2);
		setRotationAngle(cube_r2, -0.0873F, 0.0F, 0.0F);
		cube_r2.setTextureOffset(0, 0).addBox(-1.0F, -31.0F, -6.6F, 1.0F, 3.0F, 1.0F, 0.0F, false);

		cube_r3 = new ModelRenderer(this);
		cube_r3.setRotationPoint(-7.5F, 25.5065F, 3.5101F);
		head.addChild(cube_r3);
		setRotationAngle(cube_r3, 0.0873F, 0.0F, 0.0F);
		cube_r3.setTextureOffset(0, 12).addBox(-1.0F, -31.3F, -0.5F, 1.0F, 3.0F, 1.0F, 0.0F, false);

		cube_r4 = new ModelRenderer(this);
		cube_r4.setRotationPoint(-7.5F, 25.5065F, 3.5101F);
		head.addChild(cube_r4);
		setRotationAngle(cube_r4, -0.0873F, 0.0F, 0.0F);
		cube_r4.setTextureOffset(9, 0).addBox(-1.0F, -31.0F, -5.95F, 1.0F, 3.0F, 1.0F, 0.0F, false);

		cube_r5 = new ModelRenderer(this);
		cube_r5.setRotationPoint(-7.5F, 25.5065F, 1.5101F);
		head.addChild(cube_r5);
		setRotationAngle(cube_r5, 0.0873F, 0.0F, 0.0F);
		cube_r5.setTextureOffset(4, 12).addBox(-1.0F, -31.2F, 0.1F, 1.0F, 3.0F, 1.0F, 0.0F, false);

		cube_r6 = new ModelRenderer(this);
		cube_r6.setRotationPoint(-7.5F, 25.5065F, 1.5101F);
		head.addChild(cube_r6);
		setRotationAngle(cube_r6, -0.0873F, 0.0F, 0.0F);
		cube_r6.setTextureOffset(12, 3).addBox(-1.0F, -31.0F, -5.3F, 1.0F, 3.0F, 1.0F, 0.0F, false);

		cube_r7 = new ModelRenderer(this);
		cube_r7.setRotationPoint(-7.5F, 25.5065F, -0.4899F);
		head.addChild(cube_r7);
		setRotationAngle(cube_r7, 0.0873F, 0.0F, 0.0F);
		cube_r7.setTextureOffset(10, 13).addBox(-1.0F, -31.2F, 0.75F, 1.0F, 3.0F, 1.0F, 0.0F, false);

		cube_r8 = new ModelRenderer(this);
		cube_r8.setRotationPoint(-7.5F, 25.5065F, -0.4899F);
		head.addChild(cube_r8);
		setRotationAngle(cube_r8, -0.0873F, 0.0F, 0.0F);
		cube_r8.setTextureOffset(14, 13).addBox(-1.0F, -31.0F, -4.75F, 1.0F, 3.0F, 1.0F, 0.0F, false);

		cube_r9 = new ModelRenderer(this);
		cube_r9.setRotationPoint(0.5F, 23.5065F, -0.4899F);
		head.addChild(cube_r9);
		setRotationAngle(cube_r9, 0.7854F, 0.0F, 0.0F);
		cube_r9.setTextureOffset(8, 22).addBox(-9.0F, -13.05F, 16.25F, 1.0F, 1.0F, 1.4142F, 0.0F, false);
		cube_r9.setTextureOffset(8, 22).addBox(-9.0F, -20.5F, 16.25F, 1.0F, 1.0F, 1.4142F, 0.0F, false);

		cube_r10 = new ModelRenderer(this);
		cube_r10.setRotationPoint(0.5F, 23.5065F, -0.4899F);
		head.addChild(cube_r10);
		setRotationAngle(cube_r10, -0.7854F, 0.0F, 0.0F);
		cube_r10.setTextureOffset(8, 22).addBox(-9.0F, -13.75F, -17.0F, 1.0F, 1.0F, 1.4142F, 0.0F, false);
		cube_r10.setTextureOffset(8, 22).addBox(-9.0F, -21.2F, -17.0F, 1.0F, 1.0F, 1.4142F, 0.0F, false);
