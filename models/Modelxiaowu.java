...
public static class Modelxiaowu extends EntityModel<Entity> {
	...
	public Modelxiaowu() {
		...
		cube_r1.setTextureOffset(23, 14).addBox(-9.0F, -13.05F, 16.25F, 1.0F, 1.0F, 1.4142F, 0.0F, false);
		cube_r1.setTextureOffset(23, 20).addBox(-9.0F, -20.5F, 16.25F, 1.0F, 1.0F, 1.4142F, 0.0F, false);

		cube_r2 = new ModelRenderer(this);
		cube_r2.setRotationPoint(0.5F, 23.5065F, -0.4899F);
		head.addChild(cube_r2);
		setRotationAngle(cube_r2, -0.7854F, 0.0F, 0.0F);
		cube_r2.setTextureOffset(23, 17).addBox(-9.0F, -13.75F, -17.0F, 1.0F, 1.0F, 1.4142F, 0.0F, false);
		cube_r2.setTextureOffset(23, 23).addBox(-9.0F, -21.2F, -17.0F, 1.0F, 1.0F, 1.4142F, 0.0F, false);
